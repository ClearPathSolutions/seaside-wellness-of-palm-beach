...
export const metadata: Metadata = {
  title: "Our Story",
  description:
    "The story behind Seaside Wellness — luxury addiction and mental health treatment in West Palm Beach, built on clinical excellence and real connection.",
  ...pageMeta("/about/our-story"),
};
    ...
    <>
      ...
      <section className="pb-16 md:pb-24">
        <div className="container-page grid gap-4 sm:grid-cols-3">
          {[
            "/images/facility/48-web-or-mls-0E2A6426-1.jpg",
            "/images/facility/67-web-or-mls-0E2A6521.jpg",
            "/images/facility/89-web-or-mls-0E2A6631.jpg",
          ].map((src, i) => (
