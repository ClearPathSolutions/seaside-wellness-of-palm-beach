...
/**
 * The original locally-authored blog listing.
 *
 * Separators and dates use ink-500, not ink-400: ink-400 (#949aa1) measures
 * 2.84:1 on white and fails WCAG AA for text. See SW-008 in ISSUES.md. Rendered as a fallback while the
